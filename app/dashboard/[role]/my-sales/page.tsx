    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-500">Track and manage your sales records</p>
        </div>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{formatCurrency(totalRevenue / sales.length || 0)}</p>
